...
public class RecipieSaerchImp {
    ...
    public JSONObject searchRecipie(String searchRecipe) {
        ...
        try {
            ...
            recipes = food.getJSONObject("recipes");                    // { second
    ...
    private static String[] generateOauthParams() {
        return new String[]{
                ...
                // The zero-based offset into the results for the query. Use this parameter with max_results to request successive pages of search results (default value is 0).
